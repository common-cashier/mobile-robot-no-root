...
class BotActionScheduler:
    ...
    def _exec_action_process(self, action_type: ActionType, process: List[str], refresh: bool = True):
        ...
        # 循环检查次数限制，避免流程过于复杂或递归调用，包含错误检查，页面回退、页面进入等
        loop_limit = 60
