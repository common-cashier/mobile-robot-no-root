    ...
    def _curr_list(self, ctx: ActivityExecuteContext) -> bool:
        ...
        for _item in item_list:
            ...
            if _type == 1:
                ...
                # self._log(f'流水内容项长度: {len(_item_data)}')
    ...
    def _parse_item_type(self, d: u2.Device, source: str, parent_xpath: str) -> [int, str]:
        ...
        if len(sub_items) == 1:
            ...
            if date_title and self._re_title_date_year.match(date_title):
                return 1, date_title
            # elif _ele_desc_text(sub_items[0]) and StrHelper.contains('暂无数据', _ele_desc_text(sub_items[0])):
            #     none_title = _ele_desc_text(sub_items[0])
            #     return 3, none_title
        return 2, None
...
class CMBCReceiptIndexActivityExecutor(CMBCActivityExecutorBase):
    ...
    def _get_detail(self, d: u2.Device, source: str, item_parent_xpath: str):
        ...
        receipt = Receipt()
        # 内部可获取到，此处暂不设置
        # receipt.name = _ele_desc_text(d.xpath(item_parent_xpath, source).child(f'/android.view.View[1]/*[1]'))
    ...
    def _parse_detail(self, d: u2.Device, receipt: Receipt):
        ...
        # # 刘*鑫中国民生银行
        # x_payer_name_bank = d.xpath('//*[contains(@text,"付款方")]/../following-sibling::*[1]/*[2]', source)
        # # 6216 11** **** 2345
        # x_payer_card = d.xpath('//*[contains(@text,"付款方")]/../following-sibling::*[1]/*[3]', source)
        # ￥5.00
        ...
        # # 招商银行
        # x_payee_name_bank = d.xpath(f'//*{_xpath_desc_text("收款方", contains=True)}/following-sibling::*[1]/*[2]', source)
        # 6214 1234 5678 9880
        ...
        # self._log(f'收款银行:{_ele_desc_text(x_payee_name_bank).replace(receipt.name, "")}')
